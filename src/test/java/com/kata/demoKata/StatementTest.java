...
public class StatementTest {
    ...
    public void print_ShouldDisplayDepositTransaction() {
        ...
        Transaction matcherTransaction = new Transaction(Amount.getAmount(100), DateFormatter.date("24/08/2020"));

        statement.addOperation(matcherTransaction, Amount.getAmount(100));
        statement.print(printStream);
    ...
    public void print_ShouldDisplayWithdrawalTransaction() {
        ...
        Transaction matcherTransaction = new Transaction(Amount.getAmount(-100), DateFormatter.date("25/08/2020"));
